...
//> using options "-Xmacro:verbose" // Enable verbose macro processing
...
//
// NEW: The updated AnnotatedServer example demonstrates the new macro-driven approach
// for automatic schema generation and tool registration. This shows how to use Scala 3's
// metaprogramming capabilities to create a zero-boilerplate MCP tool registration experience.
//
