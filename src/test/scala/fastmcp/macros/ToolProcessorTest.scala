...
/**
 * Integration test for Tool annotation and processor
 * This tests the full workflow of tool annotation processing
 */
...
/**
 * Companion object for ToolProcessorTest containing the tools
